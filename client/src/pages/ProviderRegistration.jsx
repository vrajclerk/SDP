...
function ProviderRegistration() {
  ...
  useEffect(() => {
    if (provider.isProvider) {
      console.log("in userEffect block")
      setIsSigning(false)
  ...
  return (
    <div >
      <div className='py-3  sm:px-8 px-2 shadow flex justify-between items-center'>
      <Link to="/" className='flex items-center'>
      <img src="" className='h-8 object-contain' alt="" />
        ...
        <div className='lg:w-1/3 md:w-2/5 sm:w-2/3 w-4/5'>
          <form action="" className='flex flex-col gap-5' onSubmit={handleSubmit}>
            ...
            <div className='text-slate-900 font-semibold text-center'>
              <div >Already Have Account? Sign In here</div>
            </div>
          </form>
        </div>
      </div>
